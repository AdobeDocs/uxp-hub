...
You'll learn how to access and use Premiere APIs in the [Working with Premiere APIs](https://developer.adobe.com/premiere-pro/uxp/ppro-reference/?aio_external=true) section and by browsing the [Premiere API reference](https://developer.adobe.com/premiere-pro/uxp/ppro-reference/?aio_external=true).
...
The [What's new](../../../uxp-api/changelog.md) section lists the UXP version for each Premiere release, along with all new features, changes, and fixes.
...
- Learn how to [work with Premiere APIs](https://developer.adobe.com/premiere-pro/uxp/ppro-reference/?aio_external=true) in depth
- Browse the complete [UXP API reference](../../../uxp-api/index.md) and [Premiere API reference](https://developer.adobe.com/premiere-pro/uxp/ppro-reference/?aio_external=true)
