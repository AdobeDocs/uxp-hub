...
![A browser-style window with panels for code, settings, and content, connected to a plugin module, representing the UXP plugin architecture](assets/hero-illustration.svg)
