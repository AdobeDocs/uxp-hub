...
description: Deploy UXP plugins across an organization with Adobe Admin Console, managed packages, or UPIA.
keywords:
  - UXP Plugins
...
# Distribute in an enterprise

Enterprise and Team administrators can deploy UXP plugins through [Adobe Admin Console](https://adminconsole.adobe.com/), managed `.ccx` packages, or the [Unified Plugin Installer Agent (UPIA)](https://helpx.adobe.com/creative-cloud/apps/integration-with-other-apps/manage-plugins/install-plugins-using-upia-tool.html).
...
## 1. Deploy through Admin Console
...
This option works well when plugins are available on the Marketplace and you want simple, policy-driven distribution. See [this Admin Console documentation page](https://helpx.adobe.com/enterprise/using/manage-extensions.html#named-user-licenses) for more details.
