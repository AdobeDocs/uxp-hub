...
[CEP to UXP Technical Migration Guide](uxp-for-cep-devs/technical-migration-guide/index.md)

What's different between CEP and UXP, and API-by-API migration guidance: entry points, native CEP functions, CEP JavaScript libraries, and ExtendScript.
...
[UXP in Photoshop vs Other Host Applications](cross-host-differences/index.md)
