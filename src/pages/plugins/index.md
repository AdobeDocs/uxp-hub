...
The plugin will fetch the active project and sequence information and display it in the panel. The implementation lives in the `index.js` file, and it uses the [Premiere APIs](https://developer.adobe.com/premiere-pro/uxp/ppro-reference/?aio_external=true) to fetch the information. You can open the file and explore the code to see how it works.
